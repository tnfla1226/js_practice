...
//4. 띄어쓰기 불가능
// var user phone number = '0101-1234-1234'; (x)
var userphonenumber = 11;
//관례: convention
var user_phone_number = 1; //snake case
var userPhoneNumber = 1; //camel case : js추천
...
//변수이름은 구체적이고 명확하며 일괸되게 지어라
//ex: 회원정보 저장
var a = '홍길동'; //var userName;
var z = 'adfgdfasd@!'; //var userPassword;
var xu = 'abc1234'; // var userAccount;
var p = 'tnfla1226@naver.com'; //var userEmail;
